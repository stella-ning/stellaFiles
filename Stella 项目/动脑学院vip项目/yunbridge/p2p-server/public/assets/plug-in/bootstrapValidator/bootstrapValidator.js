(function(root,factory,plug){
	 ...
	 */
	 var __RULES__ = {
		...
		ischecked:function(){
			var $collection = $(this).find('input:checked');
	...
	var __PROTOTYPE__ = {
		_init : function(){
			...
			this.$fields = this.find(".form-group .require");
			//this.$fields = $(this).param();
		...
		_bind : function(){
			...
			this.$fields.on(this.triggerEvent,function(){
				...
				var $group = $field.parents(".group");//拿到表单组
			...
			this.on("submit",function(){
				var $groups = _$this.$fields.trigger(_$this.triggerEvent).parents(".group");
